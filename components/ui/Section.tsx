...
export function Eyebrow({ children, className }: { children: React.ReactNode; className?: string }) {
  return (
    <p className={cn("kbcf-eyebrow text-xs font-semibold uppercase tracking-[0.22em] text-primary", className)}>
      {children}
    </p>
  );
}
...
export function SectionHeading({
  ...
  return (
    <div className={cn("max-w-2xl", className)}>
      ...
      <h2 className="kbcf-section-title text-balance text-3xl font-semibold sm:text-4xl lg:text-[2.75rem]">{title}</h2>
